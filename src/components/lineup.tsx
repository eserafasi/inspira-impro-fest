        ...
        <div className="grid items-start gap-8 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-3 text-ink/75">
              Una semana en Bogotá para ver, crear y entrar en escena.
              Ubicación: Teatro R101 y Estudio La Gata Cirko.
            </p>
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {SHOWS.map((show) => (
                <article
                  key={show.day}
                  className={`${TONE[show.tone]} flex min-h-[200px] flex-col justify-between p-5`}
                >
          ...
          <div className="overflow-hidden border-4 border-navy lg:sticky lg:top-24">
            <Image
