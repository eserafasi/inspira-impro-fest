  ...
  return (
    <section id="talleres" className="scroll-mt-20 bg-navy text-cream">
      <div className="mx-auto max-w-6xl px-4 py-20">
        <div className="grid items-center gap-8 md:grid-cols-[minmax(0,1fr)_minmax(0,16rem)] lg:grid-cols-[minmax(0,1fr)_minmax(0,20rem)]">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-cream/80">
              Cuatro sesiones y 12 horas para explorar, dirigir y crear un
              formato que abre el festival. La invitada especial Viviane
              Eggers dirige ¿Listos?; Marisol Correa dirige Con-tacto. Para
              improvisadores con experiencia. Cupos limitados. Función:
              miércoles 14 de octubre en Teatro R101.
            </p>
          </div>
          <div className="mx-auto w-full max-w-xs overflow-hidden border-4 border-gold md:mx-0 md:max-w-none">
            <Image
              src="/brand/ensambles.jpg"
              alt="Talleres montaje Inspira: Con-tacto con Marisol Correa y ¿Listos? con Viviane Eggers"
              width={900}
              height={1100}
            ...
            <div className="grid items-end gap-6 md:grid-cols-2 md:gap-8">
              <div>
                ...
                <p className="mt-2 font-display text-sm uppercase tracking-[0.18em]">
                  Invitada especial · Viviane Eggers · Hamburgo
                </p>
              ...
              <Image
                ...
                width={800}
                height={1000}
                className="h-auto w-full justify-self-end md:max-w-[92%]"
              />
            </div>
          </article>
            ...
            <div className="grid items-end gap-6 md:grid-cols-2 md:gap-8">
              <div>
                ...
                <p className="mt-4 text-sm leading-relaxed text-cream/90">
                  ...
                  físicamente. Dos cuerpos, emociones, historias. O un cuerpo
                  con una silla, una pared, o alguien del público. Exploramos
                  el contacto para descubrir, con tacto, qué historia aparece.
                </p>
                <ul className="mt-5 space-y-1 text-sm">
